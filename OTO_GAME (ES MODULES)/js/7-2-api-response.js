...
// УЛУЧШЕННАЯ ВЕРСИЯ с максимально устойчивым парсингом
'use strict';
...
function normalizeChoice(choice, index) {
    ...
    // 3. REQUIREMENTS (массив строк вида "id:value")
...
function validateAndNormalizeResponse(parsedData) {
    ...
    // 6. EVENTS - МАКСИМАЛЬНО УСТОЙЧИВЫЙ ПАРСИНГ
    ...
    // 9. SUMMARY (опциональное, генерируем из сцены если отсутствует)
