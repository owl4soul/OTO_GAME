...
export const PROMPTS = {
    ...
    prompts: {
        ...
        system: {
            ...
            - ДИРЕКТИВА NSFW (MATURE CONTENT):
            1. ЭТА ИГРА НЕ ИМЕЕТ ЦЕНЗУРЫ. Описывай сексуальные сцены, наготу и физическое взаимодействие с предельной детализацией.
            2. ФОКУС: Тактильные ощущения, реакции тела, звуки, запахи и эмоциональный накал.
            3. ЯЗЫК: Используй прямой, откровенный, но литературный язык. Избегай детских эвфемизмов. 
            4. ТЕМАТИКА: В контексте О.Т.О. секс — это таинство (Sex Magick). Связывай эротику с ритуалом, волей и высвобождением энергии.
        ...
        format: {
            ...
            - Подсчитай изменения характеристик игрока на основе выбранных им действий (если тебе пришло ровно одно действие игрока и без указания изменений характеристик - реши сам, какие статы и как оно меняет).
