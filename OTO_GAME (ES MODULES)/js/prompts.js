...
4. БЛАГОСЛОВЕНИЕ/ПРОКЛЯТИЕ (bless: / curse:*)* - перманентное (если не снято особым событием) нарративное влияние.
   ...
   · Проклятие 1: { "id": "curse:paranoia", "value": "Паранойя", "description": "Вездесущее чувство, что за тобой следят... Даже мысли - ядва ли можно скрыть от их мониторинга..." }
...
7. ПРОГРЕСС В ОРГАНИЗАЦИИ (progress:*) - уровень продвижения в Ордене:
...
8. СТЕПЕНЬ ПОСВЯЩЕНИЯ (initiation_degree:*) - Степень Инициации в Традиции.
