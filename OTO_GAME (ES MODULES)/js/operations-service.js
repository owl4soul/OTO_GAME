...
class OperationsService {
    ...
    _getDefaultValue(type, name) {
        switch (type) {
            case GAME_ITEM_TYPES.STAT: return 50;
            case GAME_ITEM_TYPES.RELATIONS: return 0;
            case GAME_ITEM_TYPES.PROGRESS: return 0;
            case GAME_ITEM_TYPES.ORGANIZATION_RANK: return 0;
            case GAME_ITEM_TYPES.BUFF:
            case GAME_ITEM_TYPES.DEBUFF: return 0;
            case GAME_ITEM_TYPES.SKILL:
            case GAME_ITEM_TYPES.INVENTORY:
            case GAME_ITEM_TYPES.BLESS:
            case GAME_ITEM_TYPES.CURSE: return name || 'эффект';
            case GAME_ITEM_TYPES.PERSONALITY: return '';
            default: return null;
        }
    }
